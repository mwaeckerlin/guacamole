...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive DEBCONF_NONINTERACTIVE_SEEN=true LC_ALL=C LANGUAGE=C LANG=C apt-get install -y guacamole-tomcat tightvncserver emacs ubuntu-desktop
